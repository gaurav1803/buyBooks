...
<html>
    ...
    <body>
        ...
        <button type="submit" class="cart" onclick="location.href = 'uploadBook.php'" >Upload</button>

        <h1 align='center' ><strong>Welcome Admin, <b> <?php echo ucfirst($_SESSION['fname']); ?></strong></b> </h1>
    <br>
    <form action="#" method="post">
        ...
        if (isset($result)) {
            if (mysqli_num_rows($result) > 0) {
                echo "<table border='1.5' width='100%'>";
                echo "<tr>";
...
//                    echo "<td align='center' width=120>".' <a type="submit" name="add" class="add" href="#" >Add</a>'."<br></td>";
                    echo "</tr>";
                }
                echo "</table>";
            } else {
